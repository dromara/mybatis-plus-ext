...
import com.tangzc.mybatis.autofill.annotation.DefaultValue;
import com.tangzc.mybatis.autofill.annotation.OptionDate;
import com.tangzc.mybatis.autofill.annotation.OptionUser;
    ...
    private void setOptionUser(MetaObject metaObject, Object object, Class<?> clazz, Field field) {
        ...
        if (optionUser != null) {
            ...
            if (canSet) {
                ...
                Object userInfo;
                try {
                    userInfo = optionUser.value().getConstructor().newInstance().getVal(object, clazz, field);
                } catch (Exception e) {
